...
def default_shortcut_bindings() -> tuple[ShortcutBinding, ...]:
    return (
            ...
            ShortcutBinding("layer.copy", "Ctrl+C", "Application", 10),
            ShortcutBinding("layer.paste", "Ctrl+V", "Application", 10),
            ShortcutBinding("layer.cut", "Ctrl+X", "Application", 10),
            ShortcutBinding("layer.copy_paste", "Ctrl+K", "Application", 10),
            ...
            ShortcutBinding("application.command_palette", "Ctrl+Shift+P"),
