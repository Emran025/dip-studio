...
class DocViewerDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        header_bar.setStyleSheet("background-color: #1e293b; border-bottom: 1px solid #334155;")
        ...
        self._toggle_btn.setToolTip("إخفاء / إظهار الشريط الجانبي (Toggle Sidebar)")
        ...
        self._prev_btn.setToolTip("الصفحة السابقة")
        ...
        self._next_btn.setToolTip("الصفحة التالية")
